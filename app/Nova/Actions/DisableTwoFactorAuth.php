...
class DisbleTwoFactorAuth extends Action
{
    use InteractsWithQueue, Queueable;
    
    public $name='重置并停用Google';
    ...
    public function handle(ActionFields $fields, Collection $models)
    {
        ...
        if (!$google2fa->verifyKey($secret, $fields->verify_code)) {
            return Action::danger('验证码不正确，请确认手机中的 Google 验证码，如果Google验证器不能使用，请联系平台客服重置。');
        }
        ...
        return Action::message('Google 验证停用成功！');
    }
