...
return array(
    ...
    '休市'=>'Closed Market',
    '二级密码只能在6-16位之间' => 'The secondary password must be between 6 and 16 characters.',
    '密码和二级密码不能相同' => 'The primary and secondary passwords must not be the same.',
    '二级密码错误' => 'The secondary password is incorrect.',
    '请输入二级密码' => 'Please enter the secondary password.',
);